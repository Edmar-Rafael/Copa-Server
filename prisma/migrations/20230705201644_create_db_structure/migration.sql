...
INSERT INTO "new_Guess" ("firstTeamCountryCode", "gameId", "id", "participantId", "secondteamCountryCode") SELECT "firstTeamCountryCode", "gameId", "id", "participantId", "secondteamCountryCode" FROM "Guess";
DROP TABLE "Guess";
